...
RUN node scripts/build_site.js && node scripts/build_site_arabic_roots.js && node scripts/build_site_turkish.js && node scripts/build_catalog.js && test -f site/index.html
