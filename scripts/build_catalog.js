...
const BOOKS = [
  ...
  },
  {
    id: 'arabic-roots',
    title: 'মূল ও শাখা',
    tagline: 'কুরআনের শব্দমূল দিয়ে আরবি ভাষার গোড়া শেখা — স্টেজ ১-এর ২৫টা গাছ সম্পূর্ণ, আরও ধাপ আসছে।',
    emoji: '🌱',
    color1: '#8a5a2b',
    color2: '#e2b455',
    live: true,
  },
  {
    id: 'turkish',
    title: 'সেতু',
    tagline: 'এলিফের সাথে ধাপে ধাপে তুর্কি ভাষা — বর্ণমালা থেকে দৈনন্দিন কথোপকথন পর্যন্ত ১৯টা স্টেশনই প্রস্তুত।',
    emoji: '🌉',
    color1: '#8c1d2e',
    color2: '#e0a85a',
    live: true,
