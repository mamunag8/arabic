...
const BOOK = {
  ...
  intro: [
    ...
    '"মেরহাবা!" (Merhaba — মেরহাবা, মানে "হ্যালো") — সে হাসিমুখে বলল। এখান থেকেই শুরু। এলিফ আপনাকে ধাপে ধাপে নিয়ে যাবে তুর্কি ভাষার ভেতর দিয়ে — বিমানবন্দর থেকে বাসা, বাজার, প্রতিবেশী, মসজিদ, বিশ্ববিদ্যালয় হয়ে একদম দৈনন্দিন কথোপকথন পর্যন্ত। প্রতিটা স্টেশন একটা বাস্তব দৃশ্য, আর সেই দৃশ্যের ভেতর থেকেই সেদিনের ব্যাকরণ ও শব্দ বেরিয়ে আসে।',
...
const STATIONS = [
  ...
  },
  {
    ...
    story: [
      'ট্যাক্সিতে ব্যাগ তুলতে তুলতে এলিফ বলল, "Evdeyim (এভ-দে-য়িম) দেখেছেন কোথাও? মানে \'আমি বাড়িতে আছি\'। Ev (এভ) মানে বাড়ি — শেষে -de লাগিয়ে দিলাম, অবস্থান বোঝাতে। তুর্কিতে প্রায় সবকিছুই এভাবে হয় — মূল শব্দের শেষে একটা suffix।"',
