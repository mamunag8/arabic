...
const BOOK = {
  ...
  intro: [
    ...
    'বর্ণমালা থেকে দৈনন্দিন কথোপকথন পর্যন্ত — বইয়ের ১৯টা স্টেশনই এখন প্রস্তুত। প্রতিটা স্টেশনে সত্যিকার উচ্চারণ, বাংলার সাথে সংযোগ, আর একটা মিনি পরীক্ষা।',
  ],
...
// ---------------------------------------------------------------------------
// Station 18 -- জটিল বাক্য গঠন (Karmaşık Cümleler)
// Source: draft পর্ব ১৮ -- 5 conjunctions (fully sourced with pronunciation)
// and several two-clause example sentences (no pronunciation given for
// these, derived mechanically). The draft's own much longer fully-parsed
// showcase sentence (Ben dün sabah saat yedide...) isn't reproduced here --
// it's a single advanced illustration, not needed on top of 5 clean worked
// examples at this station's established scope.
// ---------------------------------------------------------------------------
const CONJUNCTIONS_COMPLEX = [
  ...
  ['çünkü', 'চুনকু', 'কারণ'],
  ['ya da', 'ইয়াদা', 'অথবা'],
  ['hem ... hem', 'হেম ... হেম', 'একদিকে ... অন্যদিকে'],
];

const COMPLEX_SENTENCES = [
  ['Dün arkadaşımın evine gittim ve onunla kitap okuduk.', 'দুন আর-কা-দা-শি-মিন এ-ভি-নে গিত-তিম ভে ও-নুন-লা কি-তাপ ও-কু-দুক', 'গতকাল আমি বন্ধুর বাড়িতে গিয়েছিলাম এবং আমরা বই পড়েছি।'],
  ['Sınava çok çalıştım çünkü başarılı olmak istiyorum.', 'সি-না-ভা চোক চা-লিশ-তিম চুন-কু বা-শা-রি-লি ওল-মাক ইস-তি-য়ো-রুম', 'আমি পরীক্ষার জন্য অনেক পড়াশোনা করেছি কারণ আমি সফল হতে চাই।'],
  ['Hem çalışıyorum hem de okuyorum.', 'হেম চা-লি-শি-য়ো-রুম হেম দে ও-কু-য়ো-রুম', 'আমি একদিকে কাজ করছি, অন্যদিকে পড়াশোনা করছি।'],
  ['Ya sinemaya gideceğim ya da evde kalacağım.', 'ইয়া সি-নে-মা-য়া গি-দে-জে-ইম ইয়া দা এভ-দে কা-লা-জা-ইম', 'হয় আমি সিনেমায় যাব, অথবা বাড়িতে থাকব।'],
  ['Hava soğuktu, bu yüzden evde kaldım.', 'হা-ভা সো-উক-তু, বু ইউজ-দেন এভ-দে কাল-দিম', 'আবহাওয়া ঠান্ডা ছিল, তাই আমি বাড়িতে ছিলাম।'],
];

// ---------------------------------------------------------------------------
// Station 19 -- দৈনন্দিন কথোপকথন (Günlük Konuşmalar) -- closing station.
// Source: draft পর্ব ১৯, the manuscript's own final section, fully sourced
// with pronunciation throughout. The closing/epilogue text below draws on
// the draft's own "আপনার তুর্কি ভাষা শেখার যাত্রার গল্প" epilogue (proverb,
// encouragement, next-steps advice) -- lightly adapted to speak as Elif
// rather than the book's generic narrator, not rewritten in substance.
// ---------------------------------------------------------------------------
const GREETING_WORDS = [
  ['Merhaba', 'মেরহাবা', 'হ্যালো'],
  ['Selam', 'সেলাম', 'সালাম'],
  ['Günaydın', 'গুনায়দিন', 'সুপ্রভাত'],
  ['İyi akşamlar', 'ইই আক্ষামলার', 'শুভ সন্ধ্যা'],
  ['İyi geceler', 'ইই গেজেলার', 'শুভ রাত্রি'],
];

const INTRO_WORDS = [
  ['Adınız nedir?', 'আদুনিজ নেদির', 'আপনার নাম কী?'],
  ['Benim adım ...', 'বেনিম আদম ...', 'আমার নাম ...।'],
  ['Nerelisiniz?', 'নেরেলিসিনিজ', 'আপনি কোথা থেকে এসেছেন?'],
  ['Memnun oldum.', 'মেমনুন ওলদুম', 'আপনাকে পেয়ে খুশি হলাম।'],
];

const COURTESY_WORDS = [
  ['Teşekkür ederim', 'তেশেক্কুর এদেরিম', 'ধন্যবাদ'],
  ['Rica ederim', 'রিজা এদেরিম', 'স্বাগতম'],
  ['Afedersiniz', 'আফেদার্সিনিজ', 'ক্ষমা করবেন'],
  ['Lütfen', 'লুৎফেন', 'অনুগ্রহ করে'],
  ['Hoşça kalın', 'হশ্চা কালিন', 'বিদায়'],
];
...
const STATIONS = [
  ...
  },
  {
    n: 18,
    hue: 322,
    title: 'জটিল বাক্য গঠন',
    subtitle: 'Karmaşık Cümleler',
    scene: 'কারণ ব্যাখ্যা করা, গল্প বলা',
    story: [
      'সন্ধ্যায় নানা জিজ্ঞেস করলেন কেন আজ ক্লাসে দেরি হলো। এতদিনে আপনি শুধু ছোট ছোট বাক্য দিয়ে উত্তর দিতেন — আজ প্রথমবার একটা বড় বাক্য বললেন। "Otobüs geç geldi çünkü kar yağıyordu (ও-তো-বুস গেচ গেল-দি চুন-কু কার ইয়া-য়োর-দু) — বাস দেরি করে এসেছে কারণ তুষারপাত হচ্ছিল।"',
      'এলিফ হাততালি দিল। "এই একটা বাক্যে দুইটা তথ্য জুড়ে দিলেন — çünkü (কারণ) দিয়ে। এতদিন যা শিখেছেন, সবকিছু এখন conjunction দিয়ে জোড়া লাগানো যায় — ছোট ছোট বাক্যগুলো এক লম্বা, প্রাণবন্ত গল্পে পরিণত হয়।"',
      '"পাঁচটা conjunction দিয়েই বেশিরভাগ কাজ চলে," এলিফ বলল। "ve (এবং) জুড়তে, ama (কিন্তু) বিপরীত বলতে, çünkü (কারণ) কারণ বলতে, ya da (অথবা) বিকল্প দিতে, আর hem...hem (একদিকে...অন্যদিকে) দুইটা জিনিস একসাথে বলতে। এই পাঁচটা জানলে আপনি এখন সত্যিকারের গল্প বলতে পারবেন।"',
    ],
    ruleIntro: 'গঠন: [প্রথম বাক্য] + [Conjunction] + [দ্বিতীয় বাক্য]। পাঁচটা conjunction:',
    wordClasses: [
      { icon: '🔗', title: 'Conjunctions — বাক্য জোড়া লাগানোর শব্দ', words: CONJUNCTIONS_COMPLEX },
      { icon: '📖', title: 'বাস্তব জটিল বাক্য', words: COMPLEX_SENTENCES },
    ],
    wordFormation: {
      rule: 'দুইটা সহজ বাক্যকে ve দিয়ে জোড়া লাগিয়ে একটা জটিল বাক্য বানানো — এই একই কৌশল বাকি চারটা conjunction দিয়েও কাজ করে।',
      examples: [
        { stem: 'Dün arkadaşımın evine gittim', stemMeaning: 'গতকাল বন্ধুর বাড়িতে গিয়েছিলাম (বাক্য ১)', suf: '+ ve +', result: '...gittim ve onunla kitap okuduk.', pron: '...গিত-তিম ভে ও-নুন-লা কি-তাপ ও-কু-দুক', meaning: '...গিয়েছিলাম এবং বই পড়েছি (দুই বাক্য এক হলো)' },
      ],
    },
    exercises: [
      'পাঁচটা conjunction আর তাদের অর্থ মুখস্থ বলুন, উচ্চারণসহ।',
      '"আজ আবহাওয়া ঠান্ডা ছিল, তাই আমি বাড়িতে ছিলাম" — çünkü বা bu yüzden ব্যবহার করে তুর্কিতে লিখুন।',
      'নিজের দিনের একটা ঘটনা নিয়ে একটা জটিল বাক্য (দুইটা তথ্য conjunction দিয়ে জোড়া) বলুন।',
    ],
    retrieval: {
      prompt: 'সঠিক conjunction বেছে নিন।',
      items: [
        { q: 'Hava soğuktu, ___ dışarı çıktık. (আবহাওয়া ঠান্ডা ছিল, কিন্তু আমরা বাইরে গিয়েছিলাম।)', a: 'ama (আমা)' },
        { q: 'Erken kalktım ___ toplantım vardı. (আমি তাড়াতাড়ি উঠেছিলাম কারণ আমার মিটিং ছিল।)', a: 'çünkü (চুনকু)' },
      ],
    },
    miniExam: {
      title: 'মিনি পরীক্ষা — স্টেশন ১৮',
      passRule: '৮/১০ বা তার বেশি ঠিক হলে প্রস্তুত।',
      items: [
        { q: 'পাঁচটা conjunction ও তাদের অর্থ লিখুন, উচ্চারণসহ।', a: 've(ভে,এবং), ama(আমা,কিন্তু), çünkü(চুনকু,কারণ), ya da(ইয়াদা,অথবা), hem...hem(হেম...হেম,একদিকে...অন্যদিকে)' },
        { q: '"Sınava çok çalıştım çünkü başarılı olmak istiyorum" — উচ্চারণ ও অর্থ লিখুন।', a: 'সি-না-ভা চোক চা-লিশ-তিম চুন-কু বা-শা-রি-লি ওল-মাক ইস-তি-য়ো-রুম — আমি পরীক্ষার জন্য অনেক পড়াশোনা করেছি কারণ আমি সফল হতে চাই' },
        { q: '"Hem çalışıyorum hem de okuyorum" — উচ্চারণ ও অর্থ লিখুন।', a: 'হেম চা-লি-শি-য়ো-রুম হেম দে ও-কু-য়ো-রুম — একদিকে কাজ করছি, অন্যদিকে পড়াশোনা করছি' },
        { q: 'জটিল বাক্যের মূল গঠন-নিয়মটা লিখুন।', a: '[প্রথম বাক্য] + [Conjunction] + [দ্বিতীয় বাক্য]' },
        { q: '"Ya sinemaya gideceğim ya da evde kalacağım" — অর্থ লিখুন।', a: 'হয় আমি সিনেমায় যাব, অথবা বাড়িতে থাকব' },
      ],
    },
    badge: 'গল্প-বলার ব্যাজ — জটিল বাক্য তৈরি করা শেখা হয়ে গেছে',
    next: 'বইয়ের শেষ স্টেশনে বিদায়ের আগে শেখা হবে দৈনন্দিন কথোপকথনের সবচেয়ে দরকারি বাক্যগুলো।',
  },
  {
    n: 19,
    hue: 341,
    title: 'দৈনন্দিন কথোপকথন',
    subtitle: 'Günlük Konuşmalar',
    scene: 'বিদায় ও নতুন বন্ধুত্ব',
    story: [
      'কয়েক সপ্তাহ কেটে গেছে। আজ এলিফের একটা ছোট্ট সেমিস্টার-ব্রেক শুরু, বাড়ি যাচ্ছে কিছুদিনের জন্য। এয়ারপোর্টের পথে ট্যাক্সিতে বসে এলিফ বলল, "মনে আছে প্রথম দিন কী বলেছিলাম? Merhaba (মেরহাবা)। আজ বলব উল্টোটা — কিন্তু তার আগে, চলুন পুরো কথোপকথনের বৃত্তটা সম্পূর্ণ করি।"',
      '"Selam (সেলাম), Günaydın (গুনায়দিন), İyi akşamlar (ইই আক্ষামলার), İyi geceler (ইই গেজেলার) — দিনের যেকোনো সময়ের জন্য অভিবাদন। Adınız nedir? (আদুনিজ নেদির) জিজ্ঞেস করে নতুন কারো সাথে পরিচয়, Memnun oldum (মেমনুন ওলদুম) দিয়ে শেষ।"',
      'এয়ারপোর্টে নেমে এলিফ আপনার দিকে ঘুরে দাঁড়াল। "Teşekkür ederim (তেশেক্কুর এদেরিম) — আপনাকে ধন্যবাদ, এতদিন আমার সাথে থাকার জন্য। আর এখন..." একটু থেমে হাসল। "Hoşça kalın (হশ্চা কালিন) — বিদায়, কিন্তু চিরদিনের জন্য না। শিগগিরই আবার দেখা হবে।"',
    ],
    ruleIntro: 'দৈনন্দিন কথোপকথনের সবচেয়ে দরকারি চারটা গুচ্ছ — অভিবাদন, পরিচয়, সৌজন্য:',
    wordClasses: [
      { icon: '👋', title: 'অভিবাদন (Selamlaşma)', words: GREETING_WORDS },
      { icon: '🤝', title: 'পরিচয় (Tanışma)', words: INTRO_WORDS },
      { icon: '🙏', title: 'সৌজন্যমূলক বাক্য (Nazik İfadeler)', words: COURTESY_WORDS },
    ],
    wordFormation: {
      rule: 'তুর্কিতে অনেক ভদ্রতা-বাক্য আসলে একটা বিশেষ্য/বিশেষণ + হালকা-ক্রিয়া (etmek "করা" বা olmak "হওয়া") দিয়ে তৈরি — একটা প্যাটার্ন যা বহু নতুন ক্রিয়া বানাতে কাজে লাগে।',
      examples: [
        { stem: 'Teşekkür', stemMeaning: 'ধন্যবাদ (বিশেষ্য) + etmek (করা)', suf: '→ ederim', result: 'Teşekkür ederim', pron: 'তেশেক্কুর এদেরিম', meaning: 'আমি ধন্যবাদ জানাই' },
        { stem: 'Memnun', stemMeaning: 'খুশি (বিশেষণ) + olmak (হওয়া)', suf: '→ oldum', result: 'Memnun oldum', pron: 'মেমনুন ওলদুম', meaning: 'আমি খুশি হয়েছি' },
      ],
    },
    exercises: [
      'দিনের চারটা ভিন্ন সময়ের অভিবাদন মুখস্থ বলুন, উচ্চারণসহ।',
      'নিজের সাথে একটা ছোট্ট পরিচয়-কথোপকথন বানান — নাম, কোথা থেকে এসেছেন, "Memnun oldum" দিয়ে শেষ করুন।',
      'বইয়ের শুরু থেকে এখন পর্যন্ত যা শিখেছেন, তার একটা প্রিয় বাক্য বেছে নিন আর জোরে বলুন।',
    ],
    retrieval: {
      prompt: 'সঠিক পরিস্থিতিতে সঠিক বাক্য বেছে নিন।',
      items: [
        { q: 'সকালে কাউকে দেখা হলে কী বলবেন?', a: 'Günaydın (গুনায়দিন) — সুপ্রভাত' },
        { q: 'কারো পথ আটকে গেলে ক্ষমা চাইতে কী বলবেন?', a: 'Afedersiniz (আফেদার্সিনিজ) — ক্ষমা করবেন' },
        { q: 'বিদায় নেওয়ার সময় কী বলবেন?', a: 'Hoşça kalın (হশ্চা কালিন) — বিদায়' },
      ],
    },
    miniExam: {
      title: 'মিনি পরীক্ষা — স্টেশন ১৯ (শেষ পরীক্ষা)',
      passRule: '১০/১৩ বা তার বেশি ঠিক হলে — অভিনন্দন, পুরো বইটা শেষ করেছেন!',
      items: [
        { q: 'Merhaba, Selam, Günaydın — উচ্চারণ ও অর্থ লিখুন।', a: 'মেরহাবা (হ্যালো), সেলাম (সালাম), গুনায়দিন (সুপ্রভাত)' },
        { q: 'İyi akşamlar, İyi geceler — উচ্চারণ ও অর্থ লিখুন।', a: 'ইই আক্ষামলার (শুভ সন্ধ্যা), ইই গেজেলার (শুভ রাত্রি)' },
        { q: '"আপনার নাম কী?" তুর্কিতে ও উচ্চারণসহ লিখুন।', a: 'Adınız nedir? (আদুনিজ নেদির)' },
        { q: '"আপনাকে পেয়ে খুশি হলাম" তুর্কিতে ও উচ্চারণসহ লিখুন।', a: 'Memnun oldum. (মেমনুন ওলদুম)' },
        { q: 'Teşekkür ederim, Rica ederim — উচ্চারণ ও অর্থ লিখুন।', a: 'তেশেক্কুর এদেরিম (ধন্যবাদ), রিজা এদেরিম (স্বাগতম)' },
        { q: 'Afedersiniz, Lütfen — উচ্চারণ ও অর্থ লিখুন।', a: 'আফেদার্সিনিজ (ক্ষমা করবেন), লুৎফেন (অনুগ্রহ করে)' },
        { q: '"Teşekkür ederim" শব্দটা কীভাবে তৈরি হলো?', a: 'Teşekkür (ধন্যবাদ, বিশেষ্য) + etmek (করা) → ederim (আমি করি)' },
        { q: 'বই শুরু হয়েছিল কোন শব্দ দিয়ে, শেষ হচ্ছে কোন শব্দ দিয়ে?', a: 'শুরু: Merhaba (হ্যালো) — শেষ: Hoşça kalın (বিদায়)' },
      ],
    },
    closing: {
      title: 'আপনার তুর্কি ভাষা শেখার যাত্রা',
      text: [
        'প্রিয় পাঠক, বর্ণমালা থেকে শুরু করে জটিল বাক্য পর্যন্ত — এই ১৯টা স্টেশনে আপনার যাত্রা ছিল ধৈর্য, পরিশ্রম আর মনের জোরের এক অসাধারণ উদাহরণ। ভাষা শেখা কেবল নতুন শব্দ বা ব্যাকরণ শেখা নয় — এটা একটা সংস্কৃতি, একটা সেতু, নতুন মানুষের সঙ্গে সংযোগ স্থাপনের এক অনন্য উপায়।',
        'ভুল করা শেখার একটা স্বাভাবিক অংশ। তুর্কিতে একটা প্রবাদ আছে — <strong>"Damlaya damlaya göl olur"</strong> (দামলায়া দামলায়া গোল ওলুর) — "ফোঁটা ফোঁটা জমে একটা হ্রদ হয়।" প্রতিদিনের ছোট্ট অনুশীলন একদিন একটা বড় দক্ষতায় রূপ নেবে।',
        'এখান থেকে এগিয়ে যেতে: তুর্কি ভাষায় পড়ুন — ছোট গল্প বা খবরের কাগজ। তুর্কি বন্ধু তৈরি করুন। তুর্কি সিনেমা-গান শুনুন — উচ্চারণ আর শব্দভাণ্ডার দুটোই সমৃদ্ধ হবে। আর সুযোগ পেলে এরজুরুম ঘুরে দেখুন — এই বইয়ের প্রতিটা শব্দ যেখান থেকে এসেছে।',
        '<strong>"Yeni bir dil, yeni bir hayat."</strong> (ইয়েনি বির দিল, ইয়েনি বির হায়াত) — "একটা নতুন ভাষা মানে একটা নতুন জীবন।" এই বইয়ের প্রথম পাতায় এই কথাটাই ছিল — এখন আপনি নিজেই এর মানে বোঝেন।',
      ],
    },
    badge: 'বিদায়ের ব্যাজ — বইয়ের ১৯টা স্টেশনই শেষ করা হয়ে গেছে',
    next: 'Teşekkürler ve başarılar dileriz! (তেশেক্কুরলের ভে বাশারিলার দিলেরিজ) — ধন্যবাদ এবং আপনার সাফল্য কামনা করি। এখান থেকে যেখানেই যান, তুর্কি ভাষাটা এখন আপনার সাথেই থাকবে।',
  },
];
