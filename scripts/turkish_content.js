...
// ---------------------------------------------------------------------------
// 5 practice words per letter (up from 2) -- per the user's instruction to
// use many more words per station so repetition does the memorizing, not
// just recognition. Every word below is transcribed from the draft's own
// letter table (পর্ব ১); none invented.
const ALPHABET = [
  { tr: 'A a', name: 'আ', sound: 'আ', ex: [['Araba', 'গাড়ি'], ['Arkadaş', 'বন্ধু'], ['Almak', 'নেওয়া'], ['Anlamak', 'বোঝা'], ['Akıllı', 'বুদ্ধিমান']] },
  { tr: 'B b', name: 'বে', sound: 'ব', ex: [['Baba', 'বাবা'], ['Balık', 'মাছ'], ['Bahçe', 'বাগান'], ['Bakmak', 'দেখা'], ['Başlamak', 'শুরু করা']] },
  { tr: 'C c', name: 'জে', sound: 'জ', ex: [['Cami', 'মসজিদ'], ['Ceviz', 'আখরোট'], ['Ceket', 'জ্যাকেট'], ['Canlı', 'জীবিত'], ['Ciddi', 'গম্ভীর']] },
  { tr: 'Ç ç', name: 'চে', sound: 'চ', ex: [['Çocuk', 'শিশু'], ['Çay', 'চা'], ['Çanta', 'ব্যাগ'], ['Çizmek', 'আঁকা'], ['Çıkmak', 'বের হওয়া']] },
  { tr: 'D d', name: 'দে', sound: 'দ', ex: [['Dost', 'বন্ধু'], ['Dağ', 'পাহাড়'], ['Dondurma', 'আইসক্রিম'], ['Düşmek', 'পড়ে যাওয়া'], ['Demek', 'বলা']] },
  { tr: 'E e', name: 'এ', sound: 'এ', ex: [['Ev', 'বাড়ি'], ['Elma', 'আপেল'], ['Eğlenmek', 'আনন্দ করা'], ['Etmek', 'করা'], ['Eski', 'পুরোনো']] },
  { tr: 'F f', name: 'ফে', sound: 'ফ', ex: [['Fotoğraf', 'ছবি'], ['Fincan', 'কাপ'], ['Fil', 'হাতি'], ['Fırlatmak', 'ছুঁড়ে মারা'], ['Farketmek', 'বুঝতে পারা']] },
  { tr: 'G g', name: 'গে', sound: 'গ', ex: [['Gemi', 'জাহাজ'], ['Göz', 'চোখ'], ['Gül', 'গোলাপ'], ['Gitmek', 'যাওয়া'], ['Görmek', 'দেখা']] },
  { tr: 'Ğ ğ', name: 'নরম ঘ (উচ্চারণ না করলেও চলে)', sound: 'ঘ', ex: [['Dağ', 'পাহাড়'], ['Yağ', 'তেল'], ['Ağaç', 'গাছ'], ['Sağlamak', 'প্রদান করা'], ['Bağlamak', 'বাঁধা']] },
  { tr: 'H h', name: 'হা', sound: 'হ', ex: [['Hayat', 'জীবন'], ['Hastane', 'হাসপাতাল'], ['Hoş', 'সুন্দর'], ['Harcamak', 'খরচ করা'], ['Hızlı', 'দ্রুত']] },
  { tr: 'I ı', name: 'ই (কঠিন — ই/উ-এর মাঝামাঝি)', sound: 'ই/উ', ex: [['Işık', 'আলো'], ['Isırmak', 'কামড়ানো'], ['Islak', 'ভেজা'], ['Itmek', 'ঠেলা'], ['Ilık', 'নাতিশীতোষ্ণ']] },
  { tr: 'İ i', name: 'ই (নরম)', sound: 'ই', ex: [['İnsan', 'মানুষ'], ['İzlemek', 'দেখা'], ['İçmek', 'পান করা'], ['İlaç', 'ওষুধ'], ['İyi', 'ভালো']] },
  { tr: 'J j', name: 'ঝে', sound: 'ঝ', ex: [['Jilet', 'ক্ষুর'], ['Japon', 'জাপানিজ'], ['Jelatin', 'জেলি'], ['Jandarma', 'পুলিশ'], ['Jale', 'শিশির']] },
  { tr: 'K k', name: 'কে', sound: 'ক', ex: [['Kitap', 'বই'], ['Kalem', 'কলম'], ['Kadın', 'নারী'], ['Kalkmak', 'ওঠা'], ['Konuşmak', 'কথা বলা']] },
  { tr: 'L l', name: 'লা', sound: 'ল', ex: [['Lale', 'টিউলিপ ফুল'], ['Lokum', 'মিষ্টি'], ['Lamba', 'বাতি'], ['Lütfetmek', 'করুণা করা'], ['Lazım', 'প্রয়োজনীয়']] },
  { tr: 'M m', name: 'মা', sound: 'ম', ex: [['Masa', 'টেবিল'], ['Meyve', 'ফল'], ['Merhaba', 'হ্যালো'], ['Mektup yazmak', 'চিঠি লেখা'], ['Memnun', 'সন্তুষ্ট']] },
  { tr: 'N n', name: 'না', sound: 'ন', ex: [['Nar', 'বেদানা'], ['Nehir', 'নদী'], ['Namaz', 'নামাজ'], ['Neşelenmek', 'খুশি হওয়া'], ['Not almak', 'নোট নেওয়া']] },
  { tr: 'O o', name: 'ও', sound: 'ও', ex: [['Orman', 'বন'], ['Okul', 'স্কুল'], ['Oturmak', 'বসা'], ['Olmak', 'হওয়া'], ['Otel', 'হোটেল']] },
  { tr: 'Ö ö', name: 'নরম ও (ও-উ-এর মাঝামাঝি)', sound: 'অ্য', ex: [['Ödev', 'কাজ'], ['Ölmek', 'মারা যাওয়া'], ['Ödemek', 'পরিশোধ করা'], ['Önemli', 'গুরুত্বপূর্ণ'], ['Ördek', 'হাঁস']] },
  { tr: 'P p', name: 'পে', sound: 'প', ex: [['Para', 'টাকা'], ['Pencere', 'জানালা'], ['Paylaşmak', 'ভাগ করা'], ['Pişirmek', 'রান্না করা'], ['Park', 'উদ্যান']] },
  { tr: 'R r', name: 'রে', sound: 'র', ex: [['Rüzgar', 'বাতাস'], ['Reçel', 'জ্যাম'], ['Rahat', 'আরাম'], ['Reddetmek', 'প্রত্যাখ্যান করা'], ['Radyo', 'রেডিও']] },
  { tr: 'S s', name: 'সে', sound: 'স', ex: [['Saat', 'ঘড়ি'], ['Sabır', 'ধৈর্য'], ['Sormak', 'জিজ্ঞাসা করা'], ['Sevmek', 'ভালোবাসা'], ['Sarı', 'হলুদ']] },
  { tr: 'Ş ş', name: 'শে', sound: 'শ', ex: [['Şeker', 'চিনি'], ['Şapka', 'টুপি'], ['Şemsiye', 'ছাতা'], ['Şarkı söylemek', 'গান গাওয়া'], ['Şüphelenmek', 'সন্দেহ করা']] },
  { tr: 'T t', name: 'তে', sound: 'ত', ex: [['Taş', 'পাথর'], ['Telefon', 'ফোন'], ['Tükenmek', 'শেষ হওয়া'], ['Tanışmak', 'পরিচিত হওয়া'], ['Tabak', 'থালা']] },
  { tr: 'U u', name: 'উ', sound: 'উ', ex: [['Uçak', 'বিমান'], ['Uyanmak', 'জাগ্রত হওয়া'], ['Unutmak', 'ভুলে যাওয়া'], ['Uzun', 'লম্বা'], ['Usta', 'কারিগর']] },
  { tr: 'Ü ü', name: 'ঊ (উ-ইউ-এর মাঝামাঝি)', sound: 'ঊ', ex: [['Üzüm', 'আঙ্গুর'], ['Üstlenmek', 'দায়িত্ব নেওয়া'], ['Üşümek', 'ঠান্ডা লাগা'], ['Ülke', 'দেশ'], ['Ütü', 'ইস্ত্রি']] },
  { tr: 'V v', name: 'ভে', sound: 'ভ', ex: [['Var', 'আছে'], ['Vermek', 'দেওয়া'], ['Varmak', 'পৌঁছানো'], ['Vapur', 'স্টিমার'], ['Vazo', 'ফুলদানি']] },
  { tr: 'Y y', name: 'যে', sound: 'য', ex: [['Yemek', 'খাবার'], ['Yürümek', 'হাঁটা'], ['Yatmak', 'শোয়া'], ['Yüz', 'মুখ'], ['Yıldız', 'তারা']] },
  { tr: 'Z z', name: 'জে', sound: 'জ', ex: [['Zaman', 'সময়'], ['Ziyaret etmek', 'পরিদর্শন করা'], ['Zorlamak', 'বাধ্য করা'], ['Zeytin', 'জলপাই'], ['Zürafa', 'জিরাফ']] },
];
...
const BANGLA_COGNATES = [
  { tr: 'Dost', bn: 'দোস্ত', note: 'বাংলায় ঠিক এই শব্দটাই বন্ধু বোঝাতে চলে — একই ফারসি উৎস থেকে দুই ভাষাতেই এসেছে।' },
  { tr: 'Namaz', bn: 'নামাজ', note: 'উচ্চারণ প্রায় হুবহু এক, অর্থও এক।' },
  { tr: 'Rahat', bn: 'রাহাত/আরাম', note: '"রাহাত" নামেও পরিচিত — আরাম/স্বস্তি অর্থে বাংলায় সরাসরি ব্যবহৃত হয়।' },
  { tr: 'Hayat', bn: 'হায়াত', note: '"হায়াত দারাজ হোক" বাংলায় দোয়ায় শোনা যায় — জীবন অর্থেই।' },
  { tr: 'Sabır', bn: 'সবর', note: '"সবর করো" — বাংলায় ধৈর্য ধরতে বলার সময় এই শব্দটাই ব্যবহৃত হয়।' },
  { tr: 'Lazım', bn: 'লাজিম', note: 'উর্দু-বাংলা মেশানো কথ্য ভাষায় "লাজিম" মানেই আবশ্যক/প্রয়োজনীয়।' },
  { tr: 'İlaç', bn: 'এলাজ/ইলাজ', note: '"ইলাজ করানো" — চিকিৎসা করানো অর্থে বাংলায় প্রচলিত।' },
  { tr: 'Cami', bn: 'জামে (মসজিদ)', note: '"জামে মসজিদ" নামের "জামে" এই একই আরবি উৎস থেকে।' },
];
...
const STATIONS = [
  {
    ...
    miniExam: {
      ...
      items: [
        ...
        { q: 'Araba শব্দের অর্থ কী?', a: 'গাড়ি' },
        { q: '"বন্ধু" অর্থে দুইটা তুর্কি শব্দ লিখুন (একটা A দিয়ে, একটা D দিয়ে)।', a: 'Arkadaş, Dost' },
        { q: 'Çocuk কী অর্থ বহন করে, আর Ç অক্ষরটা কীভাবে উচ্চারিত হয়?', a: 'শিশু; "চ"-এর মতো' },
        { q: 'Ğ অক্ষরটা সাধারণত কীভাবে উচ্চারণ করা হয়?', a: 'প্রায় নীরব/টেনে বলা নরম "ঘ" — Dağ (পাহাড়)-এর মতো' },
        { q: 'I ı আর İ i — এই দুইটার উচ্চারণ-পার্থক্য এক লাইনে লিখুন।', a: 'I ı কঠিন (ই/উ-এর মাঝামাঝি, Işık), İ i নরম ই (İnsan)' },
        { q: 'Kitap, Kalem, Konuşmak — প্রতিটার বাংলা অর্থ লিখুন।', a: 'বই, কলম, কথা বলা' },
        { q: 'ব্যাক ভাওয়েল ৪টা কী কী?', a: 'a, ı, o, u' },
        { q: 'ফ্রন্ট ভাওয়েল ৪টা কী কী?', a: 'e, i, ö, ü' },
        { q: 'Namaz শব্দটা বাংলাতেও প্রায় হুবহু ব্যবহৃত হয় — এর অর্থ কী?', a: 'নামাজ' },
        { q: 'Sabır শব্দটা বাংলা "সবর" শব্দের সাথে মেলে — অর্থ কী?', a: 'ধৈর্য' },
        { q: 'Üzüm, Ülke, Ütü — প্রতিটার অর্থ লিখুন।', a: 'আঙ্গুর, দেশ, ইস্ত্রি' },
        { q: 'Zaman, Yıldız — অর্থ লিখুন।', a: 'সময়, তারা' },
  ...
  },
  {
    ...
    miniExam: {
      ...
      items: [
        { q: '"Baba" শব্দে -ı, -i, -u, -ü-র মধ্যে কোনটা যোগ হবে (বাবাকে বলা হচ্ছে, নির্দিষ্ট করে)?', a: '-yı (Babayı) — a পুরু ভাওয়েল বলে -ı, স্বরে-স্বরে মিলনে -y এসে জোড়া লাগে' },
        { q: '"Araba" শব্দে -da/-de suffix যোগ করলে কী হয়, অর্থ কী?', a: 'Arabada — গাড়িতে' },
        { q: '"Okul" (স্কুল) শব্দে দিক নির্দেশ (দিকে যাওয়া) suffix যোগ করুন।', a: '-a → Okula (স্কুলে)' },
        { q: '"Okul" শব্দে উৎস (থেকে আসা) suffix যোগ করুন।', a: '-dan → Okuldan (স্কুল থেকে)' },
        { q: 'Kitap শব্দে accusative suffix যোগ করলে p-অক্ষরের কী হয়?', a: 'নরম হয়ে b হয়ে যায় — kitabı' },
        { q: 'Cep শব্দে কেন -ı নয়, -i suffix বসে?', a: 'e ফ্রন্ট ভাওয়েল বলে — cebi' },
        { q: 'Dolap শব্দের accusative রূপ ও অর্থ কী?', a: 'dolabı — আলমারিটি' },
        { q: 'Uç শব্দের accusative রূপ কী, আর কোন নিয়মে?', a: 'ucu — Ç→C পরিবর্তন + u ব্যাক ভাওয়েল' },
        { q: '"Evdeyim" বাক্যে কয়টা suffix লুকিয়ে আছে, কী কী?', a: 'দুইটা — -de (অবস্থান) আর -yim (আমি)' },
